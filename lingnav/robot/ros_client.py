...
from lingnav.core.pipeline import GEMINI_336L_INTRINSIC, LingNavPipeline
from lingnav.robot.controllers import Mpc_controller, PID_controller
from lingnav.utils.thread_utils import ReadWriteLock
...
class LingNavNode(Node):
    ...
    def __init__(self, cfg: argparse.Namespace):
        ...
        s1_client = None
        if cfg.local_s1:
            from lingnav.clients.navdp_local_client import NavDPLocalClient
